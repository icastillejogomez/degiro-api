...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var degiro, order, _a, confirmationId, freeSpaceNew, transactionFees, orderId, TIMEOUT_SECONDS, deleteOrderFunction;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, degiro.executeOrder(order, confirmationId)];
            case 3:
                orderId = _b.sent();
                console.log("Order executed with id: " + orderId);
                TIMEOUT_SECONDS = 2 * 1000;
                deleteOrderFunction = function () { return __awaiter(void 0, void 0, void 0, function () {
                    var error_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, degiro.deleteOrder(orderId)];
                            case 1:
                                _a.sent();
