...
var GET_LATESTS_NEWS = enums_1.DEGIRO_API_PATHS.GET_LATESTS_NEWS, GET_TOP_NEWS = enums_1.DEGIRO_API_PATHS.GET_TOP_NEWS;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    latestNewsURI = "" + accountConfig.data.companiesServiceUrl + GET_LATESTS_NEWS + "?" + params;
                    topNewsURI = "" + accountConfig.data.companiesServiceUrl + GET_TOP_NEWS + "?" + params;
                    result = {
                        latest: {
                            items: [],
                        },
